...
Ironically, the majority of modern science was built on the principle of sharing ideas: cross-verification and healthy challenges of assumptions/theories. But for a while, science (due to a number of reasons) started to become a closed world, with very large amounts of information and data only being available to a selected few.
